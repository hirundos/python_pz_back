...
ALLOWED_HOSTS = ['hirundos.store', 'www.hirundos.store', 'localhost', 'menu-service.default.svc.cluster.local', 'order-service.default.svc.cluster.local', 'login-service.default.svc.cluster.local']
